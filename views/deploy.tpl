...
<div>
    ...
    <div class="container row col s12">
        ...
        <div class=" container mdi-border ">
            <div class="row">
                <div class="input-field col s6">
                    <select id="remote_ip_down" name="remote_ip_down" class="browser-default select-wrapper ">
                        ...
                        <option value="3.14.168.146">aws_game1</option>
            ...
            <div>
                <a href="#" class="ReceiveFile btn-large ">下载</a>
            </div>
        </div>
        <br/>
        <br/> <br/>
        ...
        <div id="layer-modal" class="modal modal-fixed-footer">
            <div class="modal-footer">
                ...
                <a href="#!" class="modal-action btn-clear-log waves-effect waves-green btn-flat">清空</a>
